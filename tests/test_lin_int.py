...
def test_add1():
    ...
    result_dede = prob.solve(num_cpus=1, solver=dd.GUROBI, rho=0.5, num_iter=23, **GUROBI_OPTS)
...
def test_add2():
    ...
    result_dede = prob.solve(num_cpus=1, solver=dd.GUROBI, rho=0.1, num_iter=30, **GUROBI_OPTS)
    print("DeDe:", result_dede)
...
def test_constant1():
    ...
    result_dede = prob.solve(num_cpus=1, solver=dd.GUROBI, rho=1, num_iter=5, **GUROBI_OPTS)
    print("DeDe:", result_dede)
...
def test_constant2():
    ...
    result_dede = prob.solve(num_cpus=1, solver=dd.GUROBI, rho=0.5, num_iter=20, **GUROBI_OPTS)
    print("DeDe:", result_dede)
...
def test_sum1():
    ...
    result_dede = prob.solve(num_cpus=1, solver=dd.GUROBI, rho=1, num_iter=30, **GUROBI_OPTS)
    print("DeDe:", result_dede)
...
def test_sum2():
    ...
    result_dede = prob.solve(num_cpus=1, solver=dd.GUROBI, rho=1, num_iter=7, **GUROBI_OPTS)
    print("DeDe:", result_dede)
...
def test_multiply1():
    ...
    result_dede = prob.solve(num_cpus=1, solver=dd.GUROBI, rho=1, num_iter=50, **GUROBI_OPTS)
    print("DeDe:", result_dede)
...
def test_multiply2():
    ...
    result_dede = prob.solve(num_cpus=1, solver=dd.GUROBI, rho=0.4755, num_iter=90, **GUROBI_OPTS)
    print("DeDe:", result_dede)
...
def test_boolean():
    ...
    result_dede = prob.solve(num_cpus=1, solver=dd.GUROBI, rho=10, num_iter=15, **GUROBI_OPTS)
    print("DeDe:", result_dede)
