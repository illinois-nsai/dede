...
class PartitionedProblem:
    ...
    def get_allocation(self, *args, **kwargs):
        ...
        sub_problem_cluster_spec = {x: cluster_spec[x] // self._k for x in cluster_spec}
        ...
        for i, job_id in enumerate(job_ids):
            job_to_sub_problem_assignment[job_id[0]] = random.randint(0, self._k - 1)
        ...
        for i in range(self._k):
            ...
            for job_id in throughputs:
                if (job_to_sub_problem_assignment[job_id[0]] == i) and (
                    ...
                    sub_problem_throughputs[-1][job_id] = copy.copy(throughputs[job_id])
